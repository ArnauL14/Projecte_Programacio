...
class Avaluador:
    ...
    Attributes:
        _valoracins_reals (np.ndarray): Matriu de valoracions reals.
        _dataset (Dataset): Instància del conjunt de dades utilitzat per a les recomanacions.
        _valoracions (np.ndarray): Matriu de valoracions del dataset.
    """
    def __init__(self, valoracins_reals, dataset): 
        self._valoracins_reals = valoracins_reals # Matriu de valoracions reals, no hauria de ser un vector?
